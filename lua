...
UICorner.Parent = OpenItemHighlightList
...
UICorner_2.Parent = OpenLookyHighlightList
...
UIGradient.Parent = OpenLookyHighlightList
...
UICorner_3.Parent = CloseAllTabs
...
UICorner_6.Parent = OpenMonstersHighlightList

UIGradient_4.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 55, 255)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(0, 184, 2)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 110, 0))}
UIGradient_4.Parent = OpenMonstersHighlightList
...
UICorner_8.Parent = ItemsHighlightList

UIGradient_5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(170, 0, 0)), ColorSequenceKeypoint.new(0.18, Color3.fromRGB(255, 140, 0)), ColorSequenceKeypoint.new(0.34, Color3.fromRGB(255, 204, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 239, 8)), ColorSequenceKeypoint.new(0.67, Color3.fromRGB(0, 71, 185)), ColorSequenceKeypoint.new(0.85, Color3.fromRGB(97, 0, 136)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(77, 0, 144))}
UIGradient_5.Parent = ItemsHighlightList
...
UICorner_14.Parent = FoodPacks

UIGradient_7.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(255, 131, 201)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(38, 255, 0))}
UIGradient_7.Parent = FoodPacks
...
UICorner_17.Parent = Lightbulbs

UIGradient_8.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 89, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(221, 255, 0))}
UIGradient_8.Parent = Lightbulbs
...
UICorner_18.Parent = GasCanisters

SugarPacks.Name = "Sugar Packs"
SugarPacks.Parent = Chapter2
...
UICorner_19.Parent = SugarPacks

UIGradient_9.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 89, 255)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 89, 255))}
...
Chapter1_2.Parent = MonstersHighlightList

AddHighlightToBlue.Name = "AddHighlightToBlue"
AddHighlightToBlue.Parent = Chapter1_2
...
AddHighlightToPurple.Parent = Chapter2_2
